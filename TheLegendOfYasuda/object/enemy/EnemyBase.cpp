...
EnemyBase::EnemyBase(Collidable::e_Priority priority, e_GameObjectTag tag, MyLib::ColliderData::e_Kind kind, bool isTrigger) :
...
void EnemyBase::HitUpdate(VECTOR attackXPos, VECTOR attackYPos, VECTOR shockPos, float attackXRadius, float attackYRadius, float shockRadius, bool isAttack)
{
...
void EnemyBase::PlayerLockOn(Player& player)
{

}

bool EnemyBase::IsAttackXHit()
{
	//X,Y,Zの距離の成分を取得
...
bool EnemyBase::IsShockAttackHit()
{
	//X,Y,Zの距離の成分を取得
