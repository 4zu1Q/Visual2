...
{
public:
	EnemyBase(Collidable::e_Priority priority, e_GameObjectTag tag, MyLib::ColliderData::e_Kind kind, bool isTrigger);
	virtual ~EnemyBase();
	...
	const Game::e_EnemyAttackKind& GetAttackKind() const { return m_attackKind; }
...
protected:
	...
	Game::e_EnemyAttackKind m_attackKind;
